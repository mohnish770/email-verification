...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center relative min-h-screen">
      <h2 className="font-raleway font-bold text-6xl text-primary pt-20 pb-20 md:text-4xl">
        Email <span className="text-secondary">Validation</span> by Verification Saga
      </h2>
